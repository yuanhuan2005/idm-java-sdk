...
public class SignatureParam
{
	...
	{
		if (StringUtils.isStringNull(twsAccessKeyId))
		{
			return false;
		}

		if (StringUtils.isStringNull(signatureMethod))
		{
			return false;
		}

		if (StringUtils.isStringNull(signatureVersion))
		{
			return false;
		}

		if (StringUtils.isStringNull(timestamp))
		{
			return false;
		}

		if (StringUtils.isStringNull(signature))
		{
			return false;
		}
